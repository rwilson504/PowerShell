<#
.SYNOPSIS
    Acquires an access token and reports which tables are surfaced in
...
param (
    ...
    [Parameter(Mandatory = $false)] [ValidateSet("DeviceCode", "Interactive")] [string]$AuthenticationMode = "DeviceCode",
